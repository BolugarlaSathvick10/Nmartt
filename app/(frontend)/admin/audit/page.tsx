...
import type { LoginActivity, ProductActivity } from "@/types";
...
export default function AdminAuditPage() {
  ...
  const [sourceFilter, setSourceFilter] = useState<"all" | "login" | "product">("all");
  ...
  }, [loginActivities, productActivities]);
        ...
        <CardContent>
          <div className="grid gap-3 md:grid-cols-4 mb-4">
            ...
            <select
              ...
              value={sourceFilter}
              onChange={(e) => setSourceFilter(e.target.value as "all" | "login" | "product")}
            >
